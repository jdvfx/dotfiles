...
local base06 = "#bbbbbb"
local base09 = "#6699ff"
local oxocarbon = (((vim.o.background == "dark") and {base00 = base00, base01 = blend_hex(base00, base06, 0.085), base02 = blend_hex(base00, base06, 0.18), base03 = blend_hex(base00, base06, 0.3), base04 = blend_hex(base00, base06, 0.82), base05 = blend_hex(base00, base06, 0.95), base06 = base06, base07 = "#00ddaa", base08 = "#3ddbd9", base09 = base09, base10 = "#ee5396", base11 = "#33b1ff", base12 = "#ff7eb6", base13 = "#42be65", base14 = "#bb88ff", base15 = "#82cfff", blend = "#131313", none = "NONE"}) or {base00 = base06, base01 = blend_hex(base00, base06, 0.95), base02 = blend_hex(base00, base06, 0.82), base03 = base00, base04 = "#37474F", base05 = "#90A4AE", base06 = "#525252", base07 = "#08bdba", base08 = "#ff7eb6", base09 = "#ee5396", base10 = "#FF6F00", base11 = "#0f62fe", base12 = "#bb88ff", base13 = "#42be65", base14 = "#bb88ff", base15 = "#FFAB91", blend = "#FAFAFA", none = "NONE"})
...
vim.api.nvim_set_hl(0, "Cursor", {fg = oxocarbon.base00, bg = oxocarbon.base10})
vim.api.nvim_set_hl(1, "CursorLine", {fg = oxocarbon.base10, bg = oxocarbon.base05})
...
vim.api.nvim_set_hl(0, "Visual", {bg = "#301830"})
...
vim.api.nvim_set_hl(0, "InlayHints", {fg = "#284044", bg = oxocarbon.none}) -- bunker
...
vim.api.nvim_set_hl(0, "Comment", {fg = "#884499", bg = oxocarbon.none, italic = true})
...
vim.api.nvim_set_hl(0, "Number", {fg = "#ff88ff", bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "String", {fg = "#ff7788", bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "Type", {fg = "#bb88ff", bg = oxocarbon.none})
