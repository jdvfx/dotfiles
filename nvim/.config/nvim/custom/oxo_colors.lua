...
vim.api.nvim_set_hl(0, "Comment", {fg = "#9944bb", bg = oxocarbon.none, italic = true})
...
vim.api.nvim_set_hl(0, "Number", {fg = "#ffab22", bg = oxocarbon.none})
...
vim.api.nvim_set_hl(0, "String", {fg = "#44bb77", bg = oxocarbon.none})
