		...
		config = function()
			...
			cmp.setup({
				...
				mapping = cmp.mapping.preset.insert({
					...
					--  of course that should be ENTER!!!
...
-- green comments (not to be confused with TypeHints)
vim.cmd("hi Comment guifg=#226655")
...
vim.keymap.set("n", "<m-t>", ":w<cr>:!gcc %<cr>:!./a.out<cr>")
